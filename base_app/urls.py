...
from .views import (
     ...
     CreateInviteCodeView, ValidateInviteCodeView, StudentUpdateNameView
)
...
urlpatterns = [
     ...
     path("students/<int:pk>/update_name/", StudentUpdateNameView.as_view(), name="student-update-name"),
